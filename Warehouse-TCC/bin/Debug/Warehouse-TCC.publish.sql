...
GO
PRINT N'Rename refactoring operation with key 38c47d00-2601-457a-a255-7f427a274587 is skipped, element [dbo].[Clube].[Id] (SqlSimpleColumn) will not be renamed to Clubeid';
...
CREATE TABLE [dbo].[Clube] (
    ...
    PRIMARY KEY CLUSTERED ([Clubeid] ASC)
);
